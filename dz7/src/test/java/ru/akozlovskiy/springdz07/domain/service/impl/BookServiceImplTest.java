...
@DataJpaTest
//@Import({ AuthorDAOJpa.class, GenreDAOJpa.class, BookDAOJpa.class, BookServiceImpl.class,  AuthorRepositoryCustomImpl.class})
@Import({ AuthorRepositoryCustomImpl.class, BookServiceImpl.class,  AuthorRepository.class})
